...
interface BrowsingSession {
    ...
    * @since Bitwig Studio 1.2
    */
     addIsAvailableObserver(callback : (available: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.2
    */
     addIsActiveObserver(callback : (active: boolean ) => void) : void,
    /**
...
interface Channel extends DeviceChain {
    ...
    * @since Bitwig Studio 1.0
    */
     addNoteObserver(callback : (onoff: boolean, key: number, velocity: number) => void) : void,
    /**
...
interface ChannelBank {
    ...
    * @since Bitwig Studio 1.0
    */
     addChannelScrollPositionObserver(callback : (position: number ) => void, valueWhenUnassigned : number) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollChannelsUpObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollChannelsDownObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addChannelCountObserver(callback : ( count: number) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollSendsUpObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollSendsDownObserver(callback : (canscroll: boolean ) => void) : void,
    /**
...
interface Clip {
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollKeysUpObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollKeysDownObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollStepsBackwardsObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addCanScrollStepsForwardObserver(callback : (canscroll: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPlayingStepObserver(callback : (steppos: number) => void) : void,
    /**
    ...
    *
    * @param {function} callback a callback function that receives three parameters:
    1. the red coordinate of the RBG color value,
    2. the green coordinate of the RBG color value, and
    3. the blue coordinate of the RBG color value
    * @since Bitwig Studio 1.3.14
    */
     addColorObserver(callback : (red: number, green: number, blue: number ) => void) : void,
    /**
    ...
    */
    ...
    /**
    * Quantizes the start time of all notes in the clip according to the given amount.
    * The note lengths remain the same as before.
    *
    * @param {double} amount a factor between `0` and `1` that allows to morph between the original
    note start and the quantized note start.
    * @throws ControlSurfaceException
    * @since Bitwig Studio 1.3.14
    */
...
* @since Bitwig Studio 1.0
*/
interface ClipLauncherScenesOrSlots {
    /**
...
* @since Bitwig Studio 1.0
*/
interface ClipLauncherSlots extends ClipLauncherScenesOrSlots {
    /**
...
interface Cursor {
    ...
    * @since Bitwig Studio 1.1
    */
     addCanSelectPreviousObserver(callback : (canSelect: boolean) => void) : void,
    /**
...
* @since Bitwig Studio 1.2
*/
interface CursorBrowsingSession extends GenericBrowsingSession {
...
interface Device {
    ...
    * @since Bitwig Studio 1.0
    */
     addHasSelectedDeviceObserver(callback : (hasSelectedDevice: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.2
    */
     addIsPluginObserver(callback : (isPlugin: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPreviousParameterPageEnabledObserver(callback : (enabled: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addNextParameterPageEnabledObserver(callback : (enabled: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addNameObserver(len : number, textWhenUnassigned : string, callback : (name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPresetNameObserver(len : number, textWhenUnassigned : string, callback : (name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPresetCategoryObserver(len : number, textWhenUnassigned : string, callback : (category: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPresetCreatorObserver(len : number, textWhenUnassigned : string, callback : (name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addSelectedPageObserver(valueWhenUnassigned : number, callback : (index: number) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addActiveModulationSourceObserver(len : number, textWhenUnassigned : string, callback : (name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPageNamesObserver(callback : (name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addPresetNamesObserver(callback : (names: string[]) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPresetCategoriesObserver(callback : (categories: string[]) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPresetCreatorsObserver(callback : (creators: string[]) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addSlotsObserver(callback : (slotnames: string[]) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addDirectParameterIdObserver(callback : (parameterIds: string[]) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addDirectParameterValueDisplayObserver(maxChars : number, callback : (id: string, valueDisplay: string) => void) : DirectParameterValueDisplayObserver,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addDirectParameterNormalizedValueObserver(callback : (id: string, value: number) => void) : void,
    /**
    ...
    * @param {function} callback a callback function that receives a single string parameter.
    */
     addSampleNameObserver(maxChars : number, textWhenUnassigned : string, callback : (name: string) => void) : void,
    /**
...
interface DeviceBank {
    ...
    * @since Bitwig Studio 1.1
    */
     addScrollPositionObserver(callback : (position: number) => void, valueWhenUnassigned : number) : void,
    /**
...
interface DeviceChain {
    ...
    * @since Bitwig Studio 1.1
    */
     addIsSelectedInEditorObserver(callback : (selected: boolean) => void) : void,
    /**
...
interface Host {
    ...
    * @since Bitwig Studio 1.0
    */
     scheduleTask(callback : (connection: RemoteConnection ) => void, args : Object[], delay : number) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     connectToRemoteHost(host : string, port : number, callback : ( ) => void) : void,
    /**
...
interface ModulationSource {
    ...
    * @since Bitwig Studio 1.0
    */
     addIsMappingObserver(callback : (isMapping: boolean) => void) : void,
    /**
...
interface NoteInput {
    ...
    * @since Bitwig Studio 1.0
    */
     assignPolyphonicAftertouchToExpression(channel : number, expression, pitchRange : number) : void,
    /**
...
interface NoteLane {
    ...
    * @since Bitwig Studio 1.0
    */
     addNoteValueObserver(callback : (value: number) => void) : void,
    /**
...
interface PrimaryDevice extends Device {
    ...
    * @since Bitwig Studio 1.0
    */
     switchToDevice(deviceType, chainLocation) : void,
    /**
...
interface RangedValue {
    ...
    * @since Bitwig Studio 1.0
    */
     addValueObserver(range : number, callback : (value: number) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addRawValueObserver(callback : (value: number) => void) : void,
    /**
...
interface Scene {
    ...
    * @since Bitwig Studio 1.3.14
    */
     addClipCountObserver(callback : (count: number) => void) : void,
    /**
...
interface SceneBank {
    ...
    * @since Bitwig Studio 1.0
    */
     addSceneCountObserver(callback : (count: number) => void) : void,
    /**
...
* @since Bitwig Studio 1.1
*/
interface SoloValue extends BooleanValue {
    /**
...
interface Track extends Channel {
    ...
    * @since Bitwig Studio 1.1
    */
     addPositionObserver(callback : (postion: number) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.1
    */
     addIsQueuedForStopObserver(callback : (queued: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPitchNamesObserver(callback : (key: number, name: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addTrackTypeObserver(numChars : number, textWhenUnassigned : string, callback : (type: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.2
    */
     addIsGroupObserver(callback : (group: boolean) => void) : void,
    /**
...
interface TrackBank extends ChannelBank {
    ...
    * @since Bitwig Studio 1.0
    */
     addSceneScrollPositionObserver(callback : (position: number) => void, valueWhenUnassigned : number) : void,
    /**
    * Registers an observer that reports if the scene window can be scrolled further up.
    *
    * @param {function} callback a callback function that takes a single boolean parameter
    * @since Bitwig Studio 1.0
    */
     addCanScrollScenesUpObserver(callback : (canScroll: boolean) => void) : void,
    /**
    * Registers an observer that reports if the scene window can be scrolled further down.
    *
    * @param {function} callback a callback function that takes a single boolean parameter
    * @since Bitwig Studio 1.0
    */
     addCanScrollScenesDownObserver(callback : (canScroll: boolean) => void) : void,
    /**
    * Registers an observer that reports the underlying total scene count
    * (not the number of scenes available in the bank window).
    *
...
interface Transport {
    ...
    * @since Bitwig Studio 1.0
    */
     addOverdubObserver(callback : (overdub: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addLauncherOverdubObserver(callback : (overdub: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addAutomationWriteModeObserver(callback : (mode: string) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addIsWritingArrangerAutomationObserver(callback : (writeEnabled: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addIsWritingClipLauncherAutomationObserver(callback : (writingClipLauncher: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addAutomationOverrideObserver(callback : (automationOverride: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addIsLoopActiveObserver(callback : (loopActive: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPunchInObserver(callback : (enabled: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPunchOutObserver(callback : (enabled: boolean ) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addClickObserver(callback : (active: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addMetronomeTicksObserver(callback : (active: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addMetronomeVolumeObserver(callback : (value: number) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.2
    */
     addPreRollClickObserver(callback : (enabled: boolean) => void) : void,
    /**
    ...
    * @since Bitwig Studio 1.0
    */
     addPreRollObserver(callback : (enabled: boolean) => void) : void,
    /**
    ...
    */
     addClipLauncherPostRecordingActionObserver(callback : (status: string) => void) : void,
    /**
    * Sets the automation write mode.
    *
